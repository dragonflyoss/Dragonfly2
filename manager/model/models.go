...
type Model struct {
	...
	CreatedAt time.Time             `gorm:"column:created_at;type:timestamp DEFAULT CURRENT_TIMESTAMP;comment:created timestamp" json:"created_at"`
	UpdatedAt time.Time             `gorm:"column:updated_at;type:timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;comment:updated timestamp" json:"updated_at"`
