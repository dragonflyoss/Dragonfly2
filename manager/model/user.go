...
type User struct {
	...
	Avatar            string `gorm:"column:avatar;size:256;not null" json:"avatar"`
	Phone             string `gorm:"column:phone;size:256;not null" json:"phone"`
	PasswordSalt      string `gorm:"column:password;size:256;not null" json:"password"`
	PrivateToken      string `gorm:"column:private_token;size:256;not null" json:"private_token"`
