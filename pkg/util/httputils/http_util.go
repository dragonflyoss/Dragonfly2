...
// RegisterProtocol registers custom protocols in global variable "protocols" which will be used in client and server
// Example:
//   protocols := "helloworld"
//   newTransport := funcNewTransport
//   httputils.RegisterProtocol(protocols, newTransport)
// RegisterProtocol must be called before initialise dfget or scheduler instances.
...
// this function will be used in client and server
