...
var file_pkg_rpc_scheduler_scheduler_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x6e, 0x22, 0xe0, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
...
var file_pkg_rpc_scheduler_scheduler_proto_depIdxs = []int32{
	...
	14, // 9: scheduler.PieceResult.host_load:type_name -> base.HostLoad
	12, // 10: scheduler.PeerPacket.main_peer:type_name -> scheduler.PeerPacket.DestPeer
	12, // 11: scheduler.PeerPacket.steal_peers:type_name -> scheduler.PeerPacket.DestPeer
	17, // 12: scheduler.PeerPacket.code:type_name -> base.Code
	17, // 13: scheduler.PeerResult.code:type_name -> base.Code
	13, // 14: scheduler.AnnounceTaskRequest.url_meta:type_name -> base.UrlMeta
	4,  // 15: scheduler.AnnounceTaskRequest.peer_host:type_name -> scheduler.PeerHost
	18, // 16: scheduler.AnnounceTaskRequest.piece_packet:type_name -> base.PiecePacket
	1,  // 17: scheduler.Scheduler.RegisterPeerTask:input_type -> scheduler.PeerTaskRequest
	5,  // 18: scheduler.Scheduler.ReportPieceResult:input_type -> scheduler.PieceResult
	7,  // 19: scheduler.Scheduler.ReportPeerResult:input_type -> scheduler.PeerResult
	8,  // 20: scheduler.Scheduler.LeaveTask:input_type -> scheduler.PeerTarget
	9,  // 21: scheduler.Scheduler.StatTask:input_type -> scheduler.StatTaskRequest
	11, // 22: scheduler.Scheduler.AnnounceTask:input_type -> scheduler.AnnounceTaskRequest
	2,  // 23: scheduler.Scheduler.RegisterPeerTask:output_type -> scheduler.RegisterResult
	6,  // 24: scheduler.Scheduler.ReportPieceResult:output_type -> scheduler.PeerPacket
	19, // 25: scheduler.Scheduler.ReportPeerResult:output_type -> google.protobuf.Empty
	19, // 26: scheduler.Scheduler.LeaveTask:output_type -> google.protobuf.Empty
	10, // 27: scheduler.Scheduler.StatTask:output_type -> scheduler.Task
	19, // 28: scheduler.Scheduler.AnnounceTask:output_type -> google.protobuf.Empty
