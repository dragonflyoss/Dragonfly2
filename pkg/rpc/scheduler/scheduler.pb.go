...
var file_pkg_rpc_scheduler_scheduler_proto_rawDesc = []byte{
	...
	0x10, 0x01, 0x52, 0x06, 0x70, 0x65, 0x65, 0x72, 0x49, 0x64, 0x22, 0x82, 0x03, 0x0a, 0x0a, 0x50,
	...
	0x64, 0x2a, 0x27, 0x0a, 0x07, 0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x12, 0x07, 0x0a, 0x03,
	0x50, 0x32, 0x50, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x43, 0x44, 0x4e, 0x10, 0x01, 0x12, 0x0a,
	0x0a, 0x06, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x10, 0x02, 0x32, 0x9d, 0x02, 0x0a, 0x09, 0x53,
...
var file_pkg_rpc_scheduler_scheduler_proto_depIdxs = []int32{
	...
	11, // 9: scheduler.PieceResult.host_load:type_name -> base.HostLoad
	9,  // 10: scheduler.PeerPacket.main_peer:type_name -> scheduler.PeerPacket.DestPeer
	9,  // 11: scheduler.PeerPacket.steal_peers:type_name -> scheduler.PeerPacket.DestPeer
	14, // 12: scheduler.PeerPacket.code:type_name -> base.Code
	14, // 13: scheduler.PeerResult.code:type_name -> base.Code
	1,  // 14: scheduler.Scheduler.RegisterPeerTask:input_type -> scheduler.PeerTaskRequest
	5,  // 15: scheduler.Scheduler.ReportPieceResult:input_type -> scheduler.PieceResult
	7,  // 16: scheduler.Scheduler.ReportPeerResult:input_type -> scheduler.PeerResult
	8,  // 17: scheduler.Scheduler.LeaveTask:input_type -> scheduler.PeerTarget
	2,  // 18: scheduler.Scheduler.RegisterPeerTask:output_type -> scheduler.RegisterResult
	6,  // 19: scheduler.Scheduler.ReportPieceResult:output_type -> scheduler.PeerPacket
