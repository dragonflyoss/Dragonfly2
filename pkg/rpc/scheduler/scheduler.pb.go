...
var file_pkg_rpc_scheduler_scheduler_proto_rawDesc = []byte{
	...
	0x65, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x32, 0xad, 0x03, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65,
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x46, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x50,
...
var file_pkg_rpc_scheduler_scheduler_proto_depIdxs = []int32{
	...
	17, // 26: scheduler.Scheduler.StatPeerTask:output_type -> google.protobuf.Empty
	17, // 27: scheduler.Scheduler.AnnounceTask:output_type -> google.protobuf.Empty
...
type SchedulerClient interface {
	...
	StatPeerTask(ctx context.Context, in *StatPeerTaskRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *schedulerClient) StatPeerTask(ctx context.Context, in *StatPeerTaskRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type SchedulerServer interface {
	...
	// Checks if any peer has the given task
	StatPeerTask(context.Context, *StatPeerTaskRequest) (*emptypb.Empty, error)
	// A peer announces that it has the announced task to other peers
...
func (*UnimplementedSchedulerServer) StatPeerTask(context.Context, *StatPeerTaskRequest) (*emptypb.Empty, error) {
