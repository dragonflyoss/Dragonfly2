...
type PieceResult struct {
	...
	FinishedCount uint32 `protobuf:"varint,10,opt,name=finished_count,json=finishedCount,proto3" json:"finished_count,omitempty"`
}
...
func (x *PieceResult) GetFinishedCount() uint32 {
	if x != nil {
...
type PeerResult struct {
	...
	TotalPieceCount uint32    `protobuf:"varint,12,opt,name=total_piece_count,json=totalPieceCount,proto3" json:"total_piece_count,omitempty"`
}
...
func (x *PeerResult) GetTotalPieceCount() uint32 {
	if x != nil {
...
var file_pkg_rpc_scheduler_scheduler_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x66, 0x69,
	...
	0x74, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x69, 0x65, 0x63, 0x65,
