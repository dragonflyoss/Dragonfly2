...
var file_pkg_rpc_scheduler_scheduler_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xb3, 0x02, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74,
	...
	0x61, 0x6c, 0x50, 0x65, 0x65, 0x72, 0x73, 0x1a, 0x4e, 0x0a, 0x08, 0x44, 0x65, 0x73, 0x74, 0x50,
...
var file_pkg_rpc_scheduler_scheduler_proto_depIdxs = []int32{
	...
	13, // 10: scheduler.PeerResult.code:type_name -> base.Code
	0,  // 11: scheduler.Scheduler.RegisterPeerTask:input_type -> scheduler.PeerTaskRequest
	4,  // 12: scheduler.Scheduler.ReportPieceResult:input_type -> scheduler.PieceResult
	6,  // 13: scheduler.Scheduler.ReportPeerResult:input_type -> scheduler.PeerResult
	7,  // 14: scheduler.Scheduler.LeaveTask:input_type -> scheduler.PeerTarget
	1,  // 15: scheduler.Scheduler.RegisterPeerTask:output_type -> scheduler.RegisterResult
	5,  // 16: scheduler.Scheduler.ReportPieceResult:output_type -> scheduler.PeerPacket
	14, // 17: scheduler.Scheduler.ReportPeerResult:output_type -> google.protobuf.Empty
	14, // 18: scheduler.Scheduler.LeaveTask:output_type -> google.protobuf.Empty
