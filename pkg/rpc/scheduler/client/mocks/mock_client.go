...
func (m *MockSchedulerClient) UpdateAddresses(arg0 []dfnet.NetAddr) error {
	m.ctrl.T.Helper()
...
func (mr *MockSchedulerClientMockRecorder) UpdateAddresses(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAddresses", reflect.TypeOf((*MockSchedulerClient)(nil).UpdateAddresses), arg0)
}
