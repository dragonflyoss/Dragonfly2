...
func (m *MockClient) LeaveTasks(arg0 context.Context, arg1 *v1.LeaveTasksRequest, arg2 ...grpc.CallOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockClientMockRecorder) LeaveTasks(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LeaveTasks", reflect.TypeOf((*MockClient)(nil).LeaveTasks), varargs...)
}
