...
func (m *MockSchedulerClient) AnnounceTask(arg0 context.Context, arg1 *scheduler.AnnounceTaskRequest, arg2 ...grpc.CallOption) (*base.GrpcDfResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockSchedulerClient) StatPeerTask(arg0 context.Context, arg1 *scheduler.StatPeerTaskRequest, arg2 ...grpc.CallOption) (*base.GrpcDfResult, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "StatPeerTask", varargs...)
	ret0, _ := ret[0].(*base.GrpcDfResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSchedulerClientMockRecorder) StatPeerTask(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StatPeerTask", reflect.TypeOf((*MockSchedulerClient)(nil).StatPeerTask), varargs...)
}
