...
//go:generate mockgen -destination ./mocks/mock_scheduler.go -package mocks d7y.io/dragonfly/v2/pkg/rpc/scheduler Scheduler_ReportPieceResultClient,Scheduler_ReportPieceResultServer
