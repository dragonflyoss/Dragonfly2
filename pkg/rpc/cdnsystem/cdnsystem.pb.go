...
type PieceSeed struct {
	...
	PieceRange    string              `protobuf:"bytes,4,opt,name=piece_range,json=pieceRange,proto3" json:"piece_range,omitempty"`           // for transported piece content
	PieceOffset   uint64              `protobuf:"varint,5,opt,name=piece_offset,json=pieceOffset,proto3" json:"piece_offset,omitempty"`       // piece's real offset in the file
	Done          bool                `protobuf:"varint,6,opt,name=done,proto3" json:"done,omitempty"`                                        // whether or not all seeds are downloaded
	ContentLength int64               `protobuf:"varint,7,opt,name=content_length,json=contentLength,proto3" json:"content_length,omitempty"` // content total length for the url
	TotalTraffic  int64               `protobuf:"varint,8,opt,name=total_traffic,json=totalTraffic,proto3" json:"total_traffic,omitempty"`    // total traffic from the remote source
}
...
var file_pkg_rpc_cdnsystem_cdnsystem_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x22, 0xaa, 0x02, 0x0a, 0x09, 0x50, 0x69, 0x65, 0x63, 0x65, 0x53, 0x65, 0x65,
	...
	0x70, 0x69, 0x65, 0x63, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x70, 0x69, 0x65, 0x63, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x21, 0x0a,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x23, 0x0a, 0x0d, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x74, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0c, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63,
	0x32, 0x87, 0x01, 0x0a, 0x06, 0x53, 0x65, 0x65, 0x64, 0x65, 0x72, 0x12, 0x3f, 0x0a, 0x0b, 0x4f,
	...
	0x69, 0x65, 0x63, 0x65, 0x53, 0x65, 0x65, 0x64, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3c, 0x0a, 0x0d,
	...
	0x63, 0x65, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x00, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x66,
	0x6c, 0x79, 0x6f, 0x73, 0x73, 0x2f, 0x44, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x66, 0x6c, 0x79, 0x32,
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x72, 0x70, 0x63, 0x2f, 0x63, 0x64, 0x6e, 0x73, 0x79, 0x73, 0x74,
