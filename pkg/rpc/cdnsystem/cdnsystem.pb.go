...
type PieceSeed struct {
	...
	// total piece count
	TotalPieceCount uint32 `protobuf:"varint,7,opt,name=total_piece_count,json=totalPieceCount,proto3" json:"total_piece_count,omitempty"`
}
...
func (x *PieceSeed) GetTotalPieceCount() uint32 {
	if x != nil {
...
var file_pkg_rpc_cdnsystem_cdnsystem_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x0f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x69, 0x65, 0x63, 0x65, 0x43,
