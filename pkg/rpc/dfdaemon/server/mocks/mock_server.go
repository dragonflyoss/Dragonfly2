...
// Source: d7y.io/dragonfly/v2/pkg/rpc/dfdaemon/server (interfaces: DaemonServer)
...
func (m *MockDaemonServer) Download(arg0 context.Context, arg1 *dfdaemon.DownRequest, arg2 dfdaemon.Daemon_DownloadServer) error {
	m.ctrl.T.Helper()
