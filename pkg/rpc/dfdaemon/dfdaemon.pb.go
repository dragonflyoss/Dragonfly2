...
func (x *CheckHealthRequest) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
var file_pkg_rpc_dfdaemon_dfdaemon_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x64, 0x6f, 0x6e, 0x65, 0x22, 0x2c, 0x0a, 0x12, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x48,
	...
	0x72, 0x67, 0x65, 0x74, 0x32, 0xc7, 0x01, 0x0a, 0x06, 0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x12,
	0x3b, 0x0a, 0x08, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x15, 0x2e, 0x64, 0x66,
	...
	0x77, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3c, 0x0a, 0x0d,
	...
	0x63, 0x65, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x0b, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x1c, 0x2e, 0x64, 0x66, 0x64, 0x61,
	0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x00, 0x42, 0x26,
...
var file_pkg_rpc_dfdaemon_dfdaemon_proto_goTypes = []interface{}{
	...
	(*CheckHealthRequest)(nil),    // 2: dfdaemon.CheckHealthRequest
...
var file_pkg_rpc_dfdaemon_dfdaemon_proto_depIdxs = []int32{
	...
	4, // 1: dfdaemon.DownResult.state:type_name -> base.ResponseState
	0, // 2: dfdaemon.Daemon.Download:input_type -> dfdaemon.DownRequest
	5, // 3: dfdaemon.Daemon.GetPieceTasks:input_type -> base.PieceTaskRequest
	2, // 4: dfdaemon.Daemon.CheckHealth:input_type -> dfdaemon.CheckHealthRequest
	...
	4, // 7: dfdaemon.Daemon.CheckHealth:output_type -> base.ResponseState
