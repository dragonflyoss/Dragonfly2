...
type NavigatorRequest struct {
	...
	HostTag  string `protobuf:"bytes,3,opt,name=host_tag,json=hostTag,proto3" json:"host_tag,omitempty"` // client tag, json format: {vpcId:xxx,sn:xxx,...}
}
...
var file_pkg_rpc_manager_manager_proto_depIdxs = []int32{
	...
	0, // 4: manager.Manager.SyncCdnHosts:input_type -> manager.NavigatorRequest
	2, // 5: manager.Manager.GetSchedulerHosts:output_type -> manager.SchedulerHosts
	3, // 6: manager.Manager.SyncCdnHosts:output_type -> manager.CdnHosts
