...
type ListSchedulersResponse struct {
	...
	SchedulerCluster *SchedulerCluster `protobuf:"bytes,1,opt,name=scheduler_cluster,json=schedulerCluster,proto3" json:"scheduler_cluster,omitempty"`
	Schedulers       []*Scheduler      `protobuf:"bytes,2,rep,name=schedulers,proto3" json:"schedulers,omitempty"`
}
...
func (x *ListSchedulersResponse) GetSchedulerCluster() *SchedulerCluster {
	if x != nil {
		return x.SchedulerCluster
	}
	return nil
...
var file_pkg_rpc_manager_manager_proto_rawDesc = []byte{
	...
	0x94, 0x01, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a, 0x11, 0x73, 0x63,
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x5f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	...
	0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x2a, 0x45, 0x0a, 0x0a, 0x53, 0x6f, 0x75,
	...
	0x32, 0x8e, 0x03, 0x0a, 0x07, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x06,
	...
	0x01, 0x42, 0x25, 0x5a, 0x23, 0x64, 0x37, 0x79, 0x2e, 0x69, 0x6f, 0x2f, 0x64, 0x72, 0x61, 0x67,
...
var file_pkg_rpc_manager_manager_proto_depIdxs = []int32{
	...
	6,  // 11: manager.ListSchedulersResponse.scheduler_cluster:type_name -> manager.SchedulerCluster
	...
	4,  // 14: manager.Manager.GetCDN:input_type -> manager.GetCDNRequest
	5,  // 15: manager.Manager.UpdateCDN:input_type -> manager.UpdateCDNRequest
	...
	3,  // 20: manager.Manager.GetCDN:output_type -> manager.CDN
	3,  // 21: manager.Manager.UpdateCDN:output_type -> manager.CDN
