...
import (
	...
	cache "d7y.io/dragonfly/v2/pkg/cache"
...
func (mr *MockCacheMockRecorder) Delete(k interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) GetWithExpiration(k interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCache) Items() map[string]cache.Item {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Items")
	ret0, _ := ret[0].(map[string]cache.Item)
	return ret0
}
...
func (mr *MockCacheMockRecorder) Load(r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) LoadFile(fname interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) OnEvicted(f interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) Save(w interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) SaveFile(fname interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) SetDefault(k, x interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
