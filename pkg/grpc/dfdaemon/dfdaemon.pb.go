...
func (x *DownRequest) GetMd5() string {
	if x != nil {
		return x.Md5
	}
	return ""
...
var file_pkg_grpc_dfdaemon_dfdaemon_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x78, 0x0a, 0x0b, 0x44, 0x6f, 0x77, 0x6e, 0x52, 0x65,
	...
	0x35, 0x12, 0x15, 0x0a, 0x06, 0x62, 0x69, 0x7a, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x62, 0x69, 0x7a, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74,
	0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x22, 0x8f, 0x01, 0x0a, 0x0a, 0x44, 0x6f, 0x77, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12,
	...
	0x6b, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64,
	0x5f, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x63,
	...
	0x6e, 0x65, 0x32, 0x44, 0x0a, 0x0a, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x72,
	0x12, 0x36, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x15, 0x2e, 0x64, 0x66, 0x64, 0x61, 0x65, 0x6d,
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x30, 0x01, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
	...
	0x6b, 0x67, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x64, 0x66, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e,
...
var file_pkg_grpc_dfdaemon_dfdaemon_proto_depIdxs = []int32{
	2, // 0: dfdaemon.DownResult.state:type_name -> base.ResponseState
	0, // 1: dfdaemon.Downloader.Get:input_type -> dfdaemon.DownRequest
	1, // 2: dfdaemon.Downloader.Get:output_type -> dfdaemon.DownResult
...
type DownloaderClient interface {
	...
	Get(ctx context.Context, in *DownRequest, opts ...grpc.CallOption) (Downloader_GetClient, error)
}
...
func (c *downloaderClient) Get(ctx context.Context, in *DownRequest, opts ...grpc.CallOption) (Downloader_GetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Downloader_serviceDesc.Streams[0], "/dfdaemon.Downloader/Get", opts...)
	if err != nil {
		return nil, err
	}
	x := &downloaderGetClient{stream}
...
type Downloader_GetClient interface {
	Recv() (*DownResult, error)
	grpc.ClientStream
}

type downloaderGetClient struct {
	grpc.ClientStream
}

func (x *downloaderGetClient) Recv() (*DownResult, error) {
	m := new(DownResult)
...
type DownloaderServer interface {
	// download content by dragonfly
	Get(*DownRequest, Downloader_GetServer) error
}
...
func (*UnimplementedDownloaderServer) Get(*DownRequest, Downloader_GetServer) error {
...
func _Downloader_Get_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DownRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DownloaderServer).Get(m, &downloaderGetServer{stream})
}

type Downloader_GetServer interface {
	Send(*DownResult) error
	grpc.ServerStream
}

type downloaderGetServer struct {
	grpc.ServerStream
}

func (x *downloaderGetServer) Send(m *DownResult) error {
...
var _Downloader_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Get",
			Handler:       _Downloader_Get_Handler,
			ServerStreams: true,
		},
	},
