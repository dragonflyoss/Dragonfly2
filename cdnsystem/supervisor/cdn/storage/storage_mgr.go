 ...
 */
//go:generate mockgen -destination ./mock/mock_storage_mgr.go -package mock d7y.io/dragonfly/v2/cdnsystem/supervisor/cdn/storage Manager
...
type Manager interface {
	...
	// GetFreeSpace return the free space of the storage
	GetFreeSpace() int64
}
