...
// Source: d7y.io/dragonfly/v2/cdnsystem/daemon/mgr/cdn/storage (interfaces: Manager)
...
import (
	...
	storage "d7y.io/dragonfly/v2/cdnsystem/daemon/mgr/cdn/storage"
...
func (m *MockManager) Initialize(arg0 mgr.SeedTaskMgr) {
	m.ctrl.T.Helper()
