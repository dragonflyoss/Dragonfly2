...
import (
	...
	_ "d7y.io/dragonfly/v2/cdnsystem/supervise/cdn/storage/disk"   // To register diskStorage
	_ "d7y.io/dragonfly/v2/cdnsystem/supervise/cdn/storage/hybrid" // To register hybridStorage
	...
	"d7y.io/dragonfly/v2/cdnsystem/supervise/cdn/storage"
...
type Manager struct {
	...
	progressMgr      supervise.SeedProgressMgr
...
func NewManager(cfg *config.Config, cacheStore storage.Manager, progressMgr supervise.SeedProgressMgr) (supervise.CDNMgr, error) {
	return newManager(cfg, cacheStore, progressMgr)
}

func newManager(cfg *config.Config, cacheStore storage.Manager, progressMgr supervise.SeedProgressMgr) (*Manager, error) {
