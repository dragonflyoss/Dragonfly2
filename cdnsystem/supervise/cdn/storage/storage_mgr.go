 ...
 */
//go:generate mockgen -destination ./mock/mock_storage_mgr.go -package mock d7y.io/dragonfly/v2/cdnsystem/supervise/cdn/storage Manager
...
type Manager interface {
	Initialize(taskMgr supervise.SeedTaskMgr)
