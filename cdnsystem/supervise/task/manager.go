...
import (
	...
	"d7y.io/dragonfly/v2/cdnsystem/supervise/gc"
...
var _ supervise.SeedTaskMgr = (*Manager)(nil)
...
type Manager struct {
	...
	cdnMgr                  supervise.CDNMgr
	progressMgr             supervise.SeedProgressMgr
}

// NewManager returns a new Manager Object.
func NewManager(cfg *config.Config, cdnMgr supervise.CDNMgr, progressMgr supervise.SeedProgressMgr) (*Manager, error) {
	taskMgr := &Manager{
		cfg:                     cfg,
