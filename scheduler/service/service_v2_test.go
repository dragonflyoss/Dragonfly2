						...
						Hosts: []*commonv2.Host{
							{
								...
								Cpu: &commonv2.CPU{
									LogicalCount:   mockRawHost.CPU.LogicalCount,
									PhysicalCount:  mockRawHost.CPU.PhysicalCount,
									Percent:        mockRawHost.CPU.Percent,
									ProcessPercent: mockRawHost.CPU.ProcessPercent,
									Times: &commonv2.CPUTimes{
										User:      mockRawHost.CPU.Times.User,
										System:    mockRawHost.CPU.Times.System,
										Idle:      mockRawHost.CPU.Times.Idle,
										Nice:      mockRawHost.CPU.Times.Nice,
										Iowait:    mockRawHost.CPU.Times.Iowait,
										Irq:       mockRawHost.CPU.Times.Irq,
										Softirq:   mockRawHost.CPU.Times.Softirq,
										Steal:     mockRawHost.CPU.Times.Steal,
										Guest:     mockRawHost.CPU.Times.Guest,
										GuestNice: mockRawHost.CPU.Times.GuestNice,
									},
								},
								Memory: &commonv2.Memory{
									Total:              mockRawHost.Memory.Total,
									Available:          mockRawHost.Memory.Available,
									Used:               mockRawHost.Memory.Used,
									UsedPercent:        mockRawHost.Memory.UsedPercent,
									ProcessUsedPercent: mockRawHost.Memory.ProcessUsedPercent,
									Free:               mockRawHost.Memory.Free,
								},
								Network: &commonv2.Network{
									TcpConnectionCount:       mockRawHost.Network.TCPConnectionCount,
									UploadTcpConnectionCount: mockRawHost.Network.UploadTCPConnectionCount,
									Location:                 mockRawHost.Network.Location,
									Idc:                      mockRawHost.Network.IDC,
								},
								Disk: &commonv2.Disk{
									Total:             mockRawHost.Disk.Total,
									Free:              mockRawHost.Disk.Free,
									Used:              mockRawHost.Disk.Used,
									UsedPercent:       mockRawHost.Disk.UsedPercent,
									InodesTotal:       mockRawHost.Disk.InodesTotal,
									InodesUsed:        mockRawHost.Disk.InodesUsed,
									InodesFree:        mockRawHost.Disk.InodesFree,
									InodesUsedPercent: mockRawHost.Disk.InodesUsedPercent,
								},
								Build: &commonv2.Build{
									GitVersion: mockRawHost.Build.GitVersion,
									GitCommit:  mockRawHost.Build.GitCommit,
									GoVersion:  mockRawHost.Build.GoVersion,
									Platform:   mockRawHost.Build.Platform,
								},
							},
						},
			...
			mock: func(svc *V2, mr *resource.MockResourceMockRecorder, probes *networktopologymocks.MockProbes, mp *networktopologymocks.MockProbesMockRecorder,
				...
				gomock.InOrder(
					...
					mp.Enqueue(gomock.Eq(&networktopology.Probe{
						Host:      &mockRawHost,
						RTT:       mockSchedulerv2Probe.Rtt.AsDuration(),
						CreatedAt: mockSchedulerv2Probe.CreatedAt.AsTime(),
					})).Return(nil).Times(1),
					ms.Recv().Return(nil, io.EOF).Times(1),
				)
			},
