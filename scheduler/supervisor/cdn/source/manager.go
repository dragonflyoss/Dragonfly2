...
func NewManager(peerManager supervisor.PeerMgr, hostManager supervisor.HostMgr) (supervisor.CDNMgr, error) {
	mgr := &manager{
...
func (m manager) StartSeedTask(ctx context.Context, task *supervisor.Task) (*supervisor.Peer, error) {
