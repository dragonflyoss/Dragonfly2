...
// Bandwidth mocks base method.
func (m *MockNetworkTopology) Bandwidth(srcHostID, destHostID string) (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Bandwidth", srcHostID, destHostID)
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Bandwidth indicates an expected call of Bandwidth.
func (mr *MockNetworkTopologyMockRecorder) Bandwidth(srcHostID, destHostID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Bandwidth", reflect.TypeOf((*MockNetworkTopology)(nil).Bandwidth), srcHostID, destHostID)
}
...
// UpdateBandwidth mocks base method.
func (m *MockNetworkTopology) UpdateBandwidth(srcHostID, destHostID string, bandwidth float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateBandwidth", srcHostID, destHostID, bandwidth)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateBandwidth indicates an expected call of UpdateBandwidth.
func (mr *MockNetworkTopologyMockRecorder) UpdateBandwidth(srcHostID, destHostID, bandwidth interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateBandwidth", reflect.TypeOf((*MockNetworkTopology)(nil).UpdateBandwidth), srcHostID, destHostID, bandwidth)
}
