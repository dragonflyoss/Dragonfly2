...
const (
	// TypeBackToSource is metrics type of back-to-source.
	TypeBackToSource = "BACK_TO_SOURCE"

	// TypeP2p is metrics type of not back-to-source.
	TypeP2p = "P2P"
)
...
var (
	...
	}, []string{"priority", "task_type", "task_tag", "task_app", "host_type", "type"})
